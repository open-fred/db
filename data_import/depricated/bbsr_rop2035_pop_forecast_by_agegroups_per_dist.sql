-- metadata
COMMENT ON TABLE deprecated.bbsr_rop2035_pop_forecast_by_agegroups_per_dist IS '{
    "title": "BBSR - Raumordnungsprognose 2035 nach dem Zensus - Bev\u00f6lkerung in Altersgruppen - Kreise - 2012",
    "description": "Population Forecast 2012-2035 in age groups per district",
    "language": "",
    "spatial": {
        "location": "",
        "extend": "",
    ...
    "resources": [
            {"name": "deprecated.bbsr_rop2035_pop_forecast_by_agegroups_per_dist",
            "format": "PostgreSQL",
            "fields": [
                {"name": "district_id",
...
-- select description
SELECT obj_description('deprecated.bbsr_rop2035_pop_forecast_by_agegroups_per_dist' ::regclass) ::json;
...
-- metadata
COMMENT ON TABLE deprecated.bbsr_rop2035_pop_forecast_by_agegroups_per_dist IS '{
"Name": "BBSR - Raumordnungsprognose 2035 nach dem Zensus - Bevölkerung in Altersgruppen - Kreise - 2012",
...
"Original file": ["Bev_Krs_Ak_2012_2035.xlsx"],
...
{"name":"age_group",
"description":"age group",
"description_german":"Altersklasse",
"unit":"years" },
{"name":"pop_2012",
"description":"population 2012 - statistical data",
"description_german":"",
